...
public interface Options {
    ...
    Options WET_VOLUME_OPTIONS = ofGetter("volume_percentage", () -> PresenceFootsteps.getInstance().getConfig().getWetSoundsVolume() * 0.01F);
    Options FOLIAGE_VOLUME_OPTIONS = ofGetter("volume_percentage", () -> PresenceFootsteps.getInstance().getConfig().getFoliageSoundsVolume() * 0.01F);
